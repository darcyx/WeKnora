...
.page-header { display: flex; justify-content: space-between; align-items: center; gap: 16px; margin-bottom: 24px; h2 { margin: 0; font-size: var(--app-text-3xl); font-weight: 600; } p { margin: 8px 0 0; color: var(--td-text-color-secondary); } }
.stats { display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; }
.stat { text-align: left; padding: 18px 22px; border: 1px solid var(--td-component-border); border-radius: var(--app-radius-md); background: var(--td-bg-color-container); color: inherit; font: inherit; span { display: block; color: var(--td-text-color-secondary); font-size: var(--app-text-md); } strong { display: block; font-size: var(--app-text-4xl); font-weight: 600; font-variant-numeric: tabular-nums; margin-top: 8px; } }
.clickable { cursor: pointer; &:hover { border-color: var(--td-brand-color); } }
.scope-note { color: var(--td-text-color-secondary); font-size: var(--app-text-sm); margin: 10px 0 20px; }
.filters { padding: 18px 0; }.filter-row { display: flex; gap: 10px; align-items: center; flex-wrap: wrap; margin-bottom: 12px; }.search { flex: 1; min-width: 210px; }.small-select { width: 140px; }.reason-select { width: 230px; } label { display: flex; align-items: center; gap: 8px; font-size: var(--app-text-sm); color: var(--td-text-color-secondary); }
input[type=date] { font: inherit; color: var(--td-text-color-primary); background: var(--td-bg-color-container); border: 1px solid var(--td-component-border); border-radius: var(--app-radius-xs); padding: 6px; } summary { cursor: pointer; font-size: var(--app-text-md); color: var(--td-text-color-secondary); }.advanced { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 12px; margin-top: 14px; label { align-items: stretch; flex-direction: column; } }
.summary-toolbar { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 14px; p { color: var(--td-text-color-secondary); font-size: var(--app-text-sm); } }
.results { display: block; min-height: 190px; margin: 10px 0 20px; }.data-table-shell { background: var(--td-bg-color-container); border: 1px solid var(--td-component-border); border-radius: var(--app-radius-md); overflow: auto; }.question { font-weight: 500; line-height: 1.6; overflow-wrap: anywhere; }.subtext { color: var(--td-text-color-secondary); font-size: var(--app-text-sm); line-height: 1.7; margin-top: 6px; }.time { font-size: var(--app-text-sm); }.user-label { overflow-wrap: anywhere; }
.feedback-detail { font-size: var(--app-text-base); h3 { font-size: var(--app-text-xl); margin-top: 26px; } h4 { color: var(--td-text-color-secondary); font-size: var(--app-text-md); font-weight: 500; margin: 20px 0 10px; } p { line-height: 1.8; } }.detail-heading { display: flex; flex-wrap: wrap; align-items: center; gap: 12px; span { font-size: var(--app-text-sm); } }.reason-tags { display: flex; gap: 6px; margin-top: 12px; }.user-comment { border-radius: var(--app-radius-sm); padding: 4px 16px; margin-top: 16px; background: var(--td-bg-color-secondarycontainer); p { white-space: pre-wrap; overflow-wrap: anywhere; } }.plain-content { white-space: pre-wrap; overflow-wrap: anywhere; }.answer { overflow-wrap: anywhere; line-height: 1.8; padding-bottom: 16px; :deep(img) { max-width: 100%; } :deep(pre) { overflow: auto; } :deep(table) { display: block; overflow: auto; } }.identity { display: grid; grid-template-columns: 105px minmax(0, 1fr); gap: 10px; border-top: 1px solid var(--td-component-border); padding-top: 18px; margin-top: 24px; font-size: var(--app-text-sm); dt { color: var(--td-text-color-secondary); } dd { margin: 0; overflow-wrap: anywhere; } }.faq-more,.current-faq { margin: 18px 0; white-space: pre-wrap; }.drawer-footer { display: flex; gap: 10px; flex-wrap: wrap; }
@media (max-width: 768px) { .feedback-page { padding: 18px 14px; }.page-header { align-items: flex-start; }.stats { gap: 8px; }.stat { padding: 12px; strong { font-size: var(--app-text-4xl); } }.filter-row label { flex: 1; }.search,.reason-select { width: 100%; }.small-select { flex: 1; min-width: 120px; } }
</style>
